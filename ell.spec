...
Version  : 0.74
Release  : 64
URL      : https://mirrors.kernel.org/pub/linux/libs/ell/ell-0.74.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/libs/ell/ell-0.74.tar.gz
...
%prep
%setup -q -n ell-0.74
cd %{_builddir}/ell-0.74
pushd ..
cp -a ell-0.74 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741023003
