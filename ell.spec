...
Version  : 0.73
Release  : 63
URL      : https://mirrors.kernel.org/pub/linux/libs/ell/ell-0.73.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/libs/ell/ell-0.73.tar.gz
...
%prep
%setup -q -n ell-0.73
cd %{_builddir}/ell-0.73
pushd ..
cp -a ell-0.73 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739464424
