...
Source0  : https://mirrors.kernel.org/pub/linux/libs/ell/ell-0.47.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641852906
...
cp %{_builddir}/ell-0.47/COPYING %{buildroot}/usr/share/package-licenses/ell/32c7c5556c56cdbb2d507e27d28d081595a35a9b
%make_install
