...
Version  : 0.76
Release  : 66
URL      : https://mirrors.kernel.org/pub/linux/libs/ell/ell-0.76.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/libs/ell/ell-0.76.tar.gz
...
%prep
%setup -q -n ell-0.76
cd %{_builddir}/ell-0.76
pushd ..
cp -a ell-0.76 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743635712
