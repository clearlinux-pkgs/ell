...
Version  : 0.66
Release  : 56
URL      : https://mirrors.kernel.org/pub/linux/libs/ell/ell-0.66.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/libs/ell/ell-0.66.tar.gz
...
%prep
%setup -q -n ell-0.66
cd %{_builddir}/ell-0.66
pushd ..
cp -a ell-0.66 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717448058
